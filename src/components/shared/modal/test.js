      ...
      >
        <Fade in={showAddModal}>
          <Box sx={style}>
            ...
            <label className='select-input-label'>Müştəri</label>
            <Select
            IconComponent={NewIcon}
            className='customer-select select-input'
            MenuProps={MenuProps}
              displayEmpty
            ...
            <label className='select-input-label'>Məhsulun adı</label>
            <Select
            IconComponent={NewIcon}
            className='product-select select-input'
            MenuProps={MenuProps}
              displayEmpty
              inputProps={{ "aria-label": "Without label" }}
            >
